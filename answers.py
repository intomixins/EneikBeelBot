...
option2p1_photos = [
    InputMediaPhoto('AgACAgIAAxkBAAMdZO9GtDsZqP2i6ryxtq3QehZPnZoAAjzSMRvJMnhLl4b8plnBkoYBAAMCAAN4AAMwBA'),
...
basic_answer7_text = 'Для начала использования BEEL свяжитесь с нашей командой для обсуждения' \
                     ' Ваших требований. Для Вашего удобства мы подготовили Google form ' \
                     '( https://forms.gle/huXvBZufdwRJNy3e7) заподлнив которую Вы начнете ' \
...
chat_answer = 'Вы можете использовать этого бота для подачи информации нашей команде. ' \
              'Для начала, Вы прошли Google form ( https://forms.gle/huXvBZufdwRJNy3e7)?'
...
call_answer = 'Хорошо, напишите временные промежутки, когда вам удобнее будет созвониться  и  убедитесь,' \
              ...
              ' созвониться в Google Meet, то укажите это в текстовом сообщении в формате' \
              ' звонок: ((( ваш способ связи и контакт ))).'
...
meeting_answer = 'Хорошо, напишите где когда Вы бы хотели встретиться. Встретиться с' \
                 ...
                 '\nОтвет дайте в формате встреча: ((( место )))'
